package br.com.example.microservice.shipping;
...
@ComponentScan ({"br.com.example.microservice.shipping", "br.com.example.microservice.infraestructure"})
...
public class ShippingServiceApplication {
	...
	public OpenAPI openAPI() {
	      return new OpenAPI()
	              .info(new Info().title("Shipping")
	              .description("Shipping Service application")
	              .version("v0.0.1")
